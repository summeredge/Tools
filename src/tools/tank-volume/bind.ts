import { calculateTank, generateTankTable, TankVolumeError, type TankInput, type TankTableRow } from "./logic";
...
export function bindTankVolume(runtime: ToolRuntime): void {
  ...
  form.querySelector("#tank-mode")?.addEventListener("change", () => { updateTankModeLabels(); calculate(false); });
