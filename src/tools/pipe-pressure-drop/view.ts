...
export type PipeFormState = { flowBasis: PipeFlowBasis; flowValue: number; flowUnit: PipeFlowUnit; diameterMm: number; lengthM: number; densityKgM3: number; viscosityMpas: number; roughnessMm: number; sumK: number; inletPressureKpa: number };
